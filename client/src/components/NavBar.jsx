...
const NavBar = () => {
    ...
    return (
        <>
            ...
            <div className={`flex flex-1 relative left-0 z-10 md:h-full md:max-w-16 w-full bg-[#CE5A67] content-center md:block ${isOpen ? 'block' : 'hidden'}`}>
                <div className="grid grid-cols-1">
                    <div>
                        <Link href="/home" onClick={() => { setIsOpen(false) }}>
                            <div className="p-3 hover:bg-[#F4BF96] grid grid-cols-3">
                    ...
                    <div>
                        <Link href="/handwriting" onClick={() => { setIsOpen(false) }}>
                            <div className=" p-3 hover:bg-[#F4BF96] border border-x-0 border-black grid grid-cols-3">
                    ...
                    <div><Link href="/voice" onClick={() => { setIsOpen(false) }}>
                        <div className="p-3 hover:bg-[#F4BF96] border-b border-black grid grid-cols-3">
