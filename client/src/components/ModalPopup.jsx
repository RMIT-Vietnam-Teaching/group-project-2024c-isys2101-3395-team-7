...
export default function ModalPopup({ open, handleClose, title, children, onAddFavorite, onDelete, isFavorite }) {
    ...
    return (
        <>
            {open && (
                <div className="overflow-y-auto max-h-screen w-full fixed inset-0 flex items-center z-50">
                    ...
                    <div className="bg-white rounded-lg shadow-lg py-4 w-2/3 mx-auto relative">
                        ...
                        <div className="pt-8 flex flex-row justify-end mt-4 space-x-4 z-10 pr-4">
                        ...
                        <div
                            className="overflow-y-auto max-h-screen border border-black bg-gray-100 py-4 md:mx-20 mx-4 rounded-lg grid md:grid-cols-2 relative place-items-center">
                            {children}
                        </div>
                        <button
                            onClick={handleClose}
